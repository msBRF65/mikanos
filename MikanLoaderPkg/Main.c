...
{
  // ehdrとehdrのオフセットの和 = プログラムヘッダの配列を指すポインタphdr
    ...
    EFI_SYSTEM_TABLE *system_table)
{
  ...
  Print(L"Frame Buffer: 0x%8lx - 0x%8lx, Size: %lu bytes\n",
        gop->Mode->FrameBufferBase, gop->Mode->FrameBufferBase + gop->Mode->FrameBufferSize,
